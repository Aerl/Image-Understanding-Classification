...
public:
	...
	void getBagOfWords(std::vector<cv::Mat> &TestImages, std::vector<cv::Mat> &FeatureVectorsSURFUnclustered, std::vector<int> &trainingLabels, cv::Mat &clusteredFeatures, cv::Mat &labels);
};
